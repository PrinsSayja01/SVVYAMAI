    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-width section-padding relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Side - Lead Dashboard */}
          <div className="relative">
            {/* Small Robot - Half visible above dashboard */}
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 z-20">
              <div className="w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center shadow-lg animate-float">
            ...
            {/* Lead Dashboard */}
            <div className="animate-fade-up bg-card/80 backdrop-blur-sm rounded-2xl p-6 border border-border shadow-2xl">
