      ...
      <div className="container-width section-padding relative z-10">
        <div className="grid lg:grid-cols-1 gap-12 items-center">
          ...
          <div className="text-center animate-fade-up">
            ...
            {/* Subheadline */}
            <p className="text-xl md:text-2xl text-foreground/80 mb-8 leading-relaxed max-w-4xl mx-auto">
        ...
        {/* Lead Dashboard - Moved Below Content */}
        <div className="mt-16 flex justify-center animate-fade-up" style={{ animationDelay: '0.5s' }}>
          <div className="relative bg-card/80 backdrop-blur-sm rounded-2xl p-8 border border-border shadow-2xl max-w-2xl w-full">
            {/* Dashboard Preview */}
